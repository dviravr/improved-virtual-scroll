 ...
 */
function generateTreeMockData(): Record<string, TreeNode> {
  const treeData: Record<string, TreeNode> = {};

  // Create 2 grand parent nodes (IDs: 1, 2)
  const grandParentIds = ["1", "2", "3", "4"];
...
export const TREE_MOCK_DATA: Record<string, TreeNode> = generateTreeMockData();
